...
- Contains `downloadFolderImported` at any point → we have had this file before. Treat as
  watched-and-cleaned unless there is a specific reason to believe otherwise.
