...
96 | robotech_manual_import_pending | Robotech (Sonarr 74) Season 2 (Southern Cross) and Season 3 (Mospeada) full-season packs grabbed via qBittorrent (category tv-sonarr) 2026-08-22, both downloading. Once complete, do a Manual Import in Sonarr mapping the 49 files to the correct episodes (release titles don't match Sonarr's naming so this won't auto-import). Mospeada's download was crawling at ~346KB/s at grab time (may need a different release if it stalls). | AI | 2026-08-22 | open | media/docs/SONARR_STRUCTURAL_AUDIT.md
97 | escape_hatch_sweep_remaining_gaps | Apply the Prowlarr free-text search escape hatch (see #94) to the remaining "zero automated-search-result" items in media/docs/SONARR_STRUCTURAL_AUDIT.md before treating them as dead ends: Zoids Chaotic Century S1E6-34, .hack movies (G.U. Trilogy/Returner/Versus/Legend of Twilight Offline, ids 36/38/39/40), Tekkaman Blade movies (ids 68-72), Maison Ikkoku S1E22-26. The automated Sonarr/Radarr search coming back empty does not confirm the content doesn't exist on these indexers — only that the structured query didn't match. | AI | 2026-08-22 | open | media/docs/SONARR_STRUCTURAL_AUDIT.md
