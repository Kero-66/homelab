...
- [Check logs first, never assume](feedback_troubleshooting_approach.md) — `docker logs <container> --tail 30` BEFORE forming any hypothesis. Networking is rarely the cause.
