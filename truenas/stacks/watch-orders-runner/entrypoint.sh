...
FRANCHISES="trigun.json votoms.json hack.json steinsgate.json robotech.json tekkaman.json gundam_uc.json macross.json broken_blade.json evangelion.json megazone23.json"
