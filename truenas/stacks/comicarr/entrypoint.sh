#!/bin/sh
# Patched entrypoint — removes --quiet to enable logging.
# Kept in repo and mounted via compose so it survives image updates.
set -e
...
# Drop privileges and exec the application (--quiet removed to enable logging)
